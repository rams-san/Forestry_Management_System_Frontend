...
export default class UpdateContract extends React.Component{
...
axios.put('http://localhost:8080/updatecontract',contract).then(response =>{
...
function handleErrors(err){
  if(err.response){
    ...
    <div>
          ...
          <p class="h4 mb-4 text-left">Update contract</p>
