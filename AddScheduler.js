...
export default class AddScheduler extends React.Component {
...
axios.post('http://localhost:8080/addscheduler',scheduler).then(response =>{
...
function handleErrors(err){
  ...
  render(){
    return (
        ...
        <p class="h4 mb-4 text-left">Add new scheduler</p>
